...
anim.update(0.15);
console.log(`After 0.15s: Time=${anim.currentTime.toFixed(2)}, Frame=${anim.currentFrameIndex} (Expected: 1)`);

// Advance 0.2s -> Total 0.35s -> Should be in frame 2 (0.3 ~ 0.4)
anim.update(0.2);
console.log(`After +0.2s (Total 0.35s): Time=${anim.currentTime.toFixed(2)}, Frame=${anim.currentFrameIndex} (Expected: 2)`);

// Advance 0.1s -> Total 0.45s -> Loop -> 0.05s -> Frame 0
anim.update(0.1);
console.log(`After +0.1s (Total 0.45s): Time=${anim.currentTime.toFixed(2)}, Frame=${anim.currentFrameIndex} (Expected: 0)`);
